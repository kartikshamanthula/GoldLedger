...
export function SiteHeader() {
  return (
    <header className="flex h-16 items-center justify-between border-b bg-white px-4 shadow-sm">
      ...
      {/* RIGHT SIDE - Year Dropdown + Icons */}
      <div className="flex items-center gap-4">
        {/* Year Dropdown */}
        <select className="border rounded-full px-3 py-2 text-md font-medium text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 me-4">
